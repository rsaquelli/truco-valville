...
export default function CaixaPage() {
  ...
  async function carregarDados() {
    ...
    const [configResult, jogadoresResult, mensalidadesResult] =
      await Promise.all([
        supabase
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-700 sm:text-base">
              ...
              recebidos e gere cobrança por WhatsApp.
            </p>
          </div>
      ...
      <section className="rounded-[1.5rem] border border-[#071A4A]/10 bg-white/90 p-4 shadow-xl shadow-[#071A4A]/5 sm:rounded-[1.75rem] sm:p-6">
        ...
        {carregando ? (
          ...
          <div className="rounded-2xl border border-[#071A4A]/10 bg-[#FAF8F1] p-5 text-sm font-bold text-slate-500">
            Nenhuma mensalidade gerada para esta competência. Clique em “Gerar
            mensalidades”.
          </div>
        ) : (
                  ...
                  <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div className="grid gap-2 sm:grid-cols-2 lg:min-w-[430px]">
                      ...
                      <button
                        type="button"
                        disabled={salvando}
                        onClick={() => atualizarStatus(mensalidade, "pendente")}
                      ...
                      <button
                        type="button"
                        disabled={salvando}
                        onClick={() => atualizarStatus(mensalidade, "isento")}
                      ...
                      >
                        <div className="grid grid-cols-[1fr_auto] gap-2">
                          <input
                            name="valor"
                            defaultValue={String(Number(mensalidade.valor))}
                            inputMode="decimal"
